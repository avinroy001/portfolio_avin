      ...
      <div className="mt-12 md:mt-24">
        ...
        <ScrollReveal stagger={0.12} className="flex flex-col md:flex-row gap-8 items-start md:items-center">
          ...
          <div className="md:pl-2 text-center md:text-left">
            ...
            <h1 className="text-4xl sm:text-5xl font-normal tracking-tight leading-[1.15]">
              ...
              <span className="block">
                ...
                <span className="relative inline-block align-baseline">
                  <span className="relative z-10 text-[#7127BA]">specialist</span>
            ...
            <p className="mt-2 text-[10px] md:text-xs text-white/50 max-w-md md:max-w-lg mx-auto md:mx-0">
              PPC, SEO & e-commerce marketer focused on measurable growth and ROI.
            </p>
          </div>
        </ScrollReveal>
        ...
        <ScrollReveal delay={0.15} className="mt-16 max-w-3xl">
          ...
          <p className="mt-6 text-white/70 leading-7">
            Dynamic digital marketing professional with 3+ years of experience in PPC,
            SEO, and SEM. I build high-converting campaigns across Google Ads, Bing,
            Meta and LinkedIn, and use GA4, GTM and Looker Studio for measurement and
            optimisation. I focus on data-driven strategies that improve ROAS and
            grow revenue — for example, a shopping campaign that achieved 2200% ROAS
            and a remarketing overhaul that improved ad recall and conversions.
          </p>
        </ScrollReveal>
      </div>
    </section>
